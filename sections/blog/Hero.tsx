...
const Hero = () => {
  return (
    <section className="relative w-full overflow-hidden px-4 py-16 pt-5 md:py-0 md:h-[350px] lg:px-8 flex flex-col justify-center items-center isolate">
      ...
      <div className="hidden md:flex mx-auto max-w-[1165px] text-center flex-col items-center justify-center relative z-20">
        {/* Heading */}
        <h1 className="font-manrope text-4xl sm:text-5xl lg:text-[64px] font-bold leading-[80px] xl:tracking-[-1.6px] text-[#004944] max-w-[950px]">
