...
const Statement = () => {
  return (
    <section className="relative w-full overflow-hidden py-14 md:py-22 text-center px-6 sm:px-8 flex flex-col  isolate bg-[#004944]">
      {/* Background Image */}
      ...
      <div className="relative z-10 max-w-[1100px] mx-auto flex flex-col max-h-[462px]">
        ...
        <p className="md:hidden font-poppins font-normal text-[15px] leading-[26px] tracking-tight text-white/95 ">
